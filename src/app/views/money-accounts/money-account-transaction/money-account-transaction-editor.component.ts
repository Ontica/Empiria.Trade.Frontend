...
import {
  MoneyAccountTransactionItemEditorEventType
} from './money-account-transaction-item-editor.component';
...
export class MoneyAccountTransactionEditorComponent implements OnChanges, OnInit, OnDestroy {
